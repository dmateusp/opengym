...
To suggest a new feature, open a [GitHub discussion](https://github.com/your-repo/opengym/discussions). When we've discussed the feature and decided to implement it, we'll create a GitHub issue.
